...
const CategoryCard: React.FC<CategoryCardProps> = ({
    ...
    return (
        ...
        <div>
            ...
            <p className='text-[#4B5563] text-xs leading-4 font-normal font-[Inter] mt-1'>{description}</p>
        </div>
        </div>
    );
};
...
const ExploreByCategories: React.FC = () => {
    ...
    return (
        ...
        <h2 className='text-[#111827] text-4xl font-semibold !font-[Poppins] text-center'>Explore by Category</h2>
