...
const SolutionBrands = () => {
  return (
    <section className="container flex flex-col items-center py-12">
      <h2 className="text-[#000000] md:text-4xl text-xl font-semibold leading-[130%] font-Poppins max-sm:text-center">
        Assisting Educational Institutions in Emerging Markets on Their Journey
      </h2>
      <p className="text-[#5A5A5A] md:text-xl font-normal sm:leading-[150%] mt-2.5 md:text-center max-sm:text-center">
