...
const SharedTeamManagement = () => {
  return (
    <section className="container">
      <h2 className="text-[#111827] md:text-4xl text-2xl font-semibold text-center capitalize leading-[1.2] font-[Poppins]">
        Effortless management of customer and <br />
        prospect communication
      </h2>
      <div className="flex flex-col gap-5">
        <div className="flex md:flex-row flex-col items-center justify-between mt-6 sm:mt-[58px]">
          <div>
        ...
        <div className="flex max-sm:flex-col-reverse items-center justify-between">
          ...
          <div>
            ...
            <p className="text-[#4B5563] md:text-xl text-base font-normal leading-[150%] mt-5 capitalize">
              Scalable contact management with support for import/ <br />
              export via CSV files.
            </p>
            <p className="text-[#4B5563] md:text-xl text-base font-normal leading-[150%] mt-4 capitalize">
